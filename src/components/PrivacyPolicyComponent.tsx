    ...
    <div className="container mx-auto text-justify max-w-screen-lg mt-12">
      ...
      <ul className="list-disc ml-4">
        <li className="text-[18px] mb-4">
          ...
          number, and other contact details when you sign up for our newsletter,
        ...
        <li className="text-[18px] mb-4">
          ...
          browser type, operating system, pages visited, and the dates/times of
          your visits.
        </li>
        <li className="text-[18px] mb-4">
          <span className="font-bold">Cookies: </span>We use cookies to enhance
          your browsing experience, remember your preferences, and collect
          anonymous data about site usage. You can manage cookie preferences
      ...
      <ul className="list-disc ml-4">
        ...
        <li className="text-[18px] mb-4">
          <span className="font-bold">Improvement: </span>To analyze site usage
      ...
      <p className="text-[18px] mb-4">
        ...
        parties. We may share your information with trusted partners who assist
        us in operating our website, conducting our business, or serving our
        users, provided they agree to keep this information confidential. We may
        also disclose your information if required by law or to protect our
        rights.
      </p>
      ...
      <h3 className="text-[24px] font-bold font-serif mb-4 mt-8">Contact Us</h3>
      <p className="text-[18px] mb-4">
        If you have any questions about this Privacy Policy, please contact us
        at{" "}
        <Link href="mailto:contact@mentalchunks.com" className="text-blue-600">
